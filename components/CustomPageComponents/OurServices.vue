...
const text = [
  {
    id: 1,
    block: {
      title: 'Игровые и клубные сессии — <br><span>баталии за титул чемпиона</span>',
      subBlocks: [
        {
        ...
        },
        {
          ...
          img: null,
          p: [
            'Собирай команду и устраивай локальную зарубу: Mortal Kombat, Bomberman, Half-life, Counter Strike. Битва всех против всех или кооператив — решать вам.'
          ]
        },
        {
      ...
      subBlocks: [
        {
          ...
          img: null,
          p: [
            'Смотрим классику VHS-эпохи на большом экране: пледы, попкорн и культовые трейлеры. Всё по-старому, только без зажевывания пленки.'
          ]
        },
        // {
        ...
        // },
        {
          ...
          img: null,
          p: [
            'Свободный формат тусовки с приставками, музыкой, конкурсами и угаром. Взрослые дети отрываются, как в 1998-м.'
          ]
        },
        {
  ...
  },
  {
    id: 6,
    block: {
      title: 'Дни рождения и вечеринки — <br/><span>празднуем, как в подвале <br/>у лучшего друга</span>',
      subBlocks: [
        {
          subtitle: 'Аренда зоны под празднование — как в подвале у друга, но с техникой',
          img: null,
          p: [
      ...
      subBlocks: [
        {
          ...
          img: null,
          p: [
            'Никаких скучных тренингов — только заруба в Quake, Worms или StarCraft. Кто проиграл — тот делает кофе.'
          ]
        },
        {
        ...
        {
          subtitle: 'Все это и многое другое в ретро-клубе Vault57',
          img: null,
          p: [
            'Друзья, мы открыты к любым, даже самым безумным, предложениям с вашей стороны — всё обсуждаемо.'
          ]
        },
      ]
    }
